...
export const environment = {
   production: true,
   applePayMerchantID:'merchant.com.fitnessapp.ttof',//'merchant.com.fitnessapp.ttf',
   appID :  '5189d825db2284',
   apiKey : 'b9929d890607d3188df1715b5524a3d0b4cfb66b',
   paypalMode:'PayPalEnvironmentSandbox',
   serviceAPI:'https://www.totfitness.ca/fitness/api',//" http://216.187.79.152/fitness/public/api      http://192.168.1.18/fitnessProject/public/api" http://fitapp.web-brats.com/api
   payPalConfig:{
      PayPalEnvironmentProduction:'AfSgcUASBuJILjX6sHzOu1sMmnoOueY-MLAOFxMqt67PElvhy8-XwFxMWCX7NElQTFFUmCZ6_xjH9L2A',// 'YOUR_PRODUCTION_CLIENT_ID',
   ...
   termservice:'http://216.187.79.152/terms-of-service/'
