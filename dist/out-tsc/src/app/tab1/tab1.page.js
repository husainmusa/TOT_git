...
var Tab1Page = /** @class */ (function () {
    // Constructor
    function Tab1Page(restProvider, navCtrl, menuCtrl, toastCtrl, alertCtrl, loadingCtrl, formBuilder, zone, events, storage, modalController, router, route, fileChooser, media, file) {
    ...
    Tab1Page.prototype.checkSong = function () {
        this._fileList = [];
        // this.getMp3();
        ...
        this.file.listDir(this.file.syncedDataDirectory, '').then(function (result) {
            ...
            for (var _i = 0, result_1 = result; _i < result_1.length; _i++) {
                ...
                if (item.isDirectory == true && item.name != '.' && item.name != '..') {
                    ...
                    _this.getFileList(item.name);
                }
                else if (item.isFile == true) {
                    _this.saveFileToArray(item);
                }
            }
        }, function (error) {
    ...
    Tab1Page.prototype.saveFileToArray = function (item) {
        var extn = item.fullPath.split(".").pop();
    ...
    Tab1Page.prototype.getFileList = function (path) {
        var _this = this;
        var file = new File();
    ...
    Tab1Page.prototype.presentVideo = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                // console.log(id);
                this.restProvider.showLoader();
                this.restProvider.api_method('get', 'get_warmup_vids_detail/' + id, null, null).subscribe(function (data) {
                    console.log(data);
                    if (data['status'] === 'success') {
                        _this.restProvider.dismissLoader();
